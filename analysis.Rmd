...
metadata_sections <- list(
  pages = list(
    ...
    title = "Book length",
    meta_var = "pages",
    pref_labels = c("shorter books", "longer books")
  ),
  publish_year = list(
    is_categorical = FALSE,
    title = "Publish year",
    meta_var = "publish_year",
    pref_labels = c("older books", "newer books")
  ),
  goodreads_rating = list(
    is_categorical = FALSE,
    title = "Goodreads rating",
    meta_var = "goodreads_rating",
    pref_labels = c("lower rated books", "higher rated books")
  ),
  genre = list(
    is_categorical = TRUE,
    title = "Fiction vs. Non-fiction",
    meta_var = "genre",
    pref_labels = c("non-fiction", "fiction")
  ),
  author_gender = list(
    is_categorical = TRUE,
    title = "Author gender",
    ...
    pref_labels = c("male authors", "female authors")
  )
)
