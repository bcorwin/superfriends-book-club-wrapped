...
- Books read: `r get_result_value("current", "summary", "books", NA)`
- Number of ratings: `r get_result_value("current", "summary", "ratings", NA)`
- Current cycle: `r get_result_value("current", "summary", "cycle", NA)`
