...
Best: `r get_result_value("current", "books", "average", "best")`

Worst: `r get_result_value("current", "books", "average", "worst")`

```{r books-ratings-current}
make_bar_plot(books, "book", "average")
```
### To date

Best: `r get_result_value("all", "books", "average", "best")`

Worst: `r get_result_value("all", "books", "average", "worst")`

```{r books-ratings-all}
make_bar_plot(books, "book", "average", timeframe = "all")
```

## Most / Least Polarizing

Most: `r get_result_value("all", "books", "stdev", "best")`

Least: `r get_result_value("all", "books", "stdev", "worst")`
...
Best: `r get_result_value("all", "bookmakers", "average", "best")`

Worst: `r get_result_value("all", "bookmakers", "average", "worst")`
...
Most: `r get_result_value("all", "bookmakers", "stdev", "best")`

Least: `r get_result_value("all", "bookmakers", "stdev", "worst")`
...
## Highest / Lowest
Highest: `r get_result_value("all", "raters", "average", "best")`

Lowest: `r get_result_value("all", "raters", "average", "worst")`
...
## Most / Least Variable
Most: `r get_result_value("all", "raters", "stdev", "best")`

Least: `r get_result_value("all", "raters", "stdev", "worst")`
